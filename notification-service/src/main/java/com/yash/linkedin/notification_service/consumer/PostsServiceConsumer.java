package com.yash.linkedin.notification_service.consumer;


import com.yash.linkedin.notification_service.clients.ConnectionsClient;
import com.yash.linkedin.notification_service.dto.ConnectionDTO;
import com.yash.linkedin.notification_service.service.SendNotification;
...
public class PostsServiceConsumer {
    ...
    public void handlePostCreated(PostCreatedEvent postCreatedEvent) {
        ...
        List<ConnectionDTO> connections = connectionsClient.getFirstConnections(postCreatedEvent.getCreatorId());
